...
if ( ! class_exists( 'Upsite_Lite_Toolkit_Menu_Item_Custom_Fields' ) ) :
	/**
	* Menu Item Custom Fields Loader
	*/
	class Upsite_Lite_Toolkit_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'Upside_Lite_Toolkit_Menu_Item_Custom_Fields_Walker';
			if ( ! class_exists( $walker ) ) {
				require_once ULT_PATH . 'api/menu-item-custom-fields/walker-nav-menu-edit.php';
			}

			return $walker;
		}
	}
	add_action( 'wp_loaded', array( 'Upsite_Lite_Toolkit_Menu_Item_Custom_Fields', 'load' ), 9 );
endif;

require_once ULT_PATH . 'api/menu-item-custom-fields/hook.php';
